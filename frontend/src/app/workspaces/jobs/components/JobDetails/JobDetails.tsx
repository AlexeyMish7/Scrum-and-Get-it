            ...
            {editMode ? (
              ...
              <>
                ...
                <Typography variant="body2">
                  Location: {String(job?.city_name ?? "-")},{" "}
                  {String(job?.state_code ?? "-")} {String(job?.zipcode ?? "-")}
                </Typography>
                <Typography variant="body2">
                  Salary:{" "}
          ...
          <Stack spacing={1}>
            ...
            {editMode ? (
              ...
              <>
                ...
                (note?.application_history as Array<Record<string, unknown>>)
                  .length > 0 ? (
                  (note?.application_history as Array<Record<string, unknown>>)
                    .slice()
                    .reverse()
                    .map((h, i) => {
                      ...
                      return (
                        <Box key={i} sx={{ mt: 1 }}>
                          ...
                          <Typography variant="body2">{`To: ${String(
                            h.to ?? "-"
                          )}`}</Typography>
                        </Box>
                      );
