...
const aiTheme = createTheme({
  ...
  components: {
    ...
    // Type color & subtle headline glow
    MuiTypography: {
      variants: [
        {
          props: { variant: "h1" },
    ...
    MuiButton: {
      styleOverrides: {
        ...
        contained: {
          // Electric cobalt gradient to keep primary button undeniably blue
          backgroundImage:
    ...
    // Extras: Chip, Tabs, Tooltip, Dialog, Divider
    MuiChip: {
      styleOverrides: {
        root: {
