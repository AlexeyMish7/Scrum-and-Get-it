 ...
 *
 * WHAT: Template library management interface (view, import, export templates)
 ...
 * - Import example templates (modern, minimal)
    ...
    <Box>
      ...
      <Alert severity="info" icon={<InfoIcon />} sx={{ mb: 3 }}>
        <Typography variant="body2">
          <strong>How to use templates:</strong> Manage your template library
          here. When creating a new cover letter, go to the{" "}
          <strong>Cover Letter Editor</strong> where you'll select a template
          as part of the creation flow.
        </Typography>
        <Typography variant="caption" display="block" sx={{ mt: 1 }}>
          💡 Example templates (Modern, Minimal) are available in{" "}
          <code>/docs/ai/example-templates/</code> or download using buttons
          above.
        </Typography>
      </Alert>
